...
function Zuruecksetzen(){
	let canvas = document.getElementById("myCanvas");
	let histcanvas = document.getElementById("histoCan");
		let context = histcanvas.getContext("2d");
	context.clearRect(0, 0, histcanvas.width, histcanvas.height);
	let ctx = canvas.getContext("2d");
	let srcImg = document.getElementById("whales");
	canvas.height = 650;
	canvas.width = 1050;
